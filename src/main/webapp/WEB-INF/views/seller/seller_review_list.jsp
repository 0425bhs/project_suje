...
<head>
    ...
    <link rel="stylesheet"
          href="/css/seller/seller_form_common.css">

    <link rel="stylesheet"
          href="/css/seller/seller_product_list.css">

    <link rel="stylesheet"
          href="/css/seller/seller_review.css">
        ...
        <div class="seller-main">
            ...
            <div class="seller-main-header">
                ...
                <div>
                    ...
                    <p>
                        판매자가 등록한 상품의 작성된 리뷰를 확인하고 관리할 수 있습니다.
                    </p>
                </div>
            ...
            <div class="review-summary-box">
                ...
                <div class="review-filter-wrap">
                    ...
                    <select id="productFilter" class="review-filter-select">
                        ...
                        <option value="" ${empty selectedProductId ? 'selected' : ''}>
                            전체 상품 리뷰
                        </option>

                        <c:forEach var="product" items="${productList}">

                            <option value="${product.product_id}" ${selectedProductId eq product.product_id ? 'selected' : ''}>
            ...
            <div class="seller-review-wrap">
                ...
                <div class="review-tab-box">
                    ...
                    <button type="button" class="review-tab ${selectedTab eq 'all' ? 'active' : ''}" data-tab="all">
                        전체 리뷰
                    </button>


                    <button type="button" class="review-tab ${selectedTab eq 'waiting' ? 'active' : ''}" data-tab="waiting">

                        답글 대기

                        <span id="waitingTabCount">
                            (${waitingReviewCount})
                        </span>
                    </button>


                    <button type="button" class="review-tab ${selectedTab eq 'completed' ? 'active' : ''}" data-tab="completed">
                        답글 완료
                        <span id="completedTabCount">
                            (${completedReviewCount})
                        </span>
                    </button>


                    <button type="button" class="review-tab ${selectedTab eq 'photo' ? 'active' : ''}" data-tab="photo">
                        사진 리뷰
                        <span id="photoTabCount">
                            (${photoReviewCount})
                        </span>
                    </button>
                                        ...
                                        <div class="review-user-area">
                                            ...
                                            <div class="review-user-info">
                                                    ...
                                                    <span class="review-user-name">
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${not empty review.user_name and fn:length(review.user_name) >= 2}">
                                                                ...
                                                                )}*${fn:substring( review.user_name, 2, fn:length(review.user_name) )}
                                                ...
                                                <div class="review-product-line">
                                                    ...
                                                    <span class="review-product-title">
                                                        ${review.product_name}
                                                    </span>

                                                    <c:if test="${not empty review.option_name}">

                                                        <span class="review-option-title">
                                                            , ${review.option_name}
                                                        </span>
                    ...
                    <div class="seller-page-menu">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${pagination.startPage > 1}">
                                ...
                                <c:url var="prevUrl" value="/seller_review_list.do">
                                    ...
                                    <c:if test="${not empty selectedProductId}">
                                        ...
                                        <c:param name="product_id" value="${selectedProductId}" />
                        ...
                        <c:forEach var="i" begin="${pagination.startPage}" end="${pagination.endPage}">
                            ...
                            <c:choose>
                                ...
                                <c:otherwise>
                                    ...
                                    <c:url var="pageUrl" value="/seller_review_list.do">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${pagination.endPage < pagination.totalPage}">

                                <c:url var="nextUrl" value="/seller_review_list.do">
    ...
    <div id="reviewReportModal" class="review-report-modal-bg">
        ...
        <div class="review-report-modal">
            ...
            <div class="review-report-modal-actions">
                ...
                <button type="button" class="review-report-cancel-btn">
                    취소
                </button>

                <button type="button" class="review-report-submit-btn">
                    신고하기
                </button>
