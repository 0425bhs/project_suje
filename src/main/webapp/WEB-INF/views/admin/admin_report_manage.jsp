            ...
            <form class="admin-filter-form" action="/admin/reports" method="get">
                <div class="admin-filter-main-row">
                    ...
                    <select class="admin-filter-control admin-sort-control" name="sort">
                        ...
                        <option value="target">대상순</option>
                    </select>
                    ...
                    <div class="admin-filter-applied">
                        ...
                        <c:if test="${status ne 'all'}">
                            <a class="admin-filter-chip"
                                href="/admin/reports?status=all&keyword=${keyword}&size=${pagination.size}&page=1">
                                상태:
                        ...
                        <c:if test="${not empty keyword}">
                            <a class="admin-filter-chip" href="/admin/reports?status=${status}&size=${pagination.size}&page=1">
                                검색어: ${keyword}
                                <span aria-hidden="true">&times;</span>
                            </a>
                        </c:if>
