    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
                ...
                <c:set var="isAlwaysSale" value="${vo.price > 0 and vo.sale_price > 0 and vo.sale_price < vo.price and empty saleStartDate and empty saleEndDate}" />

                <c:set var="isPeriodSale" value="${vo.price > 0 and vo.sale_price > 0 and vo.sale_price < vo.price and not empty saleStartDate and not empty saleEndDate and today ge saleStartDate and today le saleEndDate}" />
                    ...
                    <div class="store-detail-page">
                        ...
                        <div class="store-detail-layout">
                                ...
                                <div class="store-main-image-box">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${not empty vo.imageList}">
                                            <img id="detailMainImage" src="/upload/${vo.imageList[0].image_url}"
                                                alt="${vo.name}">
                                        </c:when>
                                ...
                                <div class="store-thumb-row">
                                    ...
                                    <c:if test="${not empty vo.imageList}">
                                        <c:forEach var="img" items="${vo.imageList}">
                                            <button type="button" class="store-thumb-btn"
                                                data-img="/upload/${img.image_url}">
                                        ...
                                        <div class="review-preview-list">
                                            ...
                                            <c:forEach var="review" items="${bestReview}" varStatus="status">
                                                <div class="review-preview-card">
                                                    ...
                                                    <c:set var="reviewPreviewImage"
                                                        value="${fn:trim(review.review_image)}" />

                                                    <c:choose>
                                                        <c:when
                                                            test="${not empty reviewPreviewImage and reviewPreviewImage ne 'no_file'}">
                                                            <c:choose>
                                                                <c:when
                                                                    test="${fn:startsWith(reviewPreviewImage, '/upload/')}">
                                                                    <img class="review-preview-img"
                                                                        src="${reviewPreviewImage}">
                                                                </c:when>

                                                                <c:otherwise>
                                                                    <img class="review-preview-img"
                                                                        src="/upload/${reviewPreviewImage}">
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </c:when>
                            ...
                            <section class="store-detail-right">
                                ...
                                <div class="store-seller-line">
                                    ...
                                    <button type="button" class="wish-shop-btn ${favorite ? 'active' : ''}"
                                        id="sellerWishBtn" data-seller-id="${vo.seller_id}">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${hasOption}">
                                            ...
                                            <div class="product-option-box">
                                                ...
                                                <select id="option_id" class="product-option-select"
                                                    data-unit-price="${unitPrice}" ${vo.status ne 'APPROVED' or isSoldOut ? 'disabled' : '' }>
                                                    ...
                                                    <c:forEach var="option" items="${vo.optionList}">
                                                        <option value="${option.option_id}" data-option-name="${option.option_name}" data-price="${option.option_price}"
                                                            ...
                                                            <c:if test="${option.option_price gt 0}">
                                                                (+
                                                                <fmt:formatNumber value="${option.option_price}"
                                                                    pattern="#,###" />원)
                                                            </c:if>
                                            ...
                                            <div id="selectedOptionBox" class="selected-option-list"
                                                style="display:none;">
                                            </div>
                        ...
                        <section class="product-review-box store-tab-panel" id="reviewBox">
                            ...
                            <c:if test="${not empty review_list}">
                                ...
                                <c:set var="reviewAvg"
                                    value="${reviewTotalCount > 0 ? ratingSum / reviewTotalCount : 0}" />
                                ...
                                <div class="detail-review-area">
                                        ...
                                        <div class="review-score-bars">
                                            ...
                                            <div class="review-score-row">
                                                ...
                                                <div class="review-score-track">
                                                    <div class="review-score-fill" data-percent="${rating5Percent}">
                                                    </div>
                                                </div>
                                                <em>
                                                    <fmt:formatNumber value="${rating5Percent}" pattern="0" />%
                                                </em>
                                            </div>
                                            ...
                                            <div class="review-score-row">
                                                <span>4점</span>
                                                <div class="review-score-track">
                                                    <div class="review-score-fill" data-percent="${rating4Percent}">
                                                    </div>
                                                </div>
                                                <em>
                                                    <fmt:formatNumber value="${rating4Percent}" pattern="0" />%
                                                </em>
                                            </div>
                                            ...
                                            <div class="review-score-row">
                                                <span>3점</span>
                                                <div class="review-score-track">
                                                    <div class="review-score-fill" data-percent="${rating3Percent}">
                                                    </div>
                                                </div>
                                                <em>
                                                    <fmt:formatNumber value="${rating3Percent}" pattern="0" />%
                                                </em>
                                            </div>
                                            ...
                                            <div class="review-score-row">
                                                <span>2점</span>
                                                <div class="review-score-track">
                                                    <div class="review-score-fill" data-percent="${rating2Percent}">
                                                    </div>
                                                </div>
                                                <em>
                                                    <fmt:formatNumber value="${rating2Percent}" pattern="0" />%
                                                </em>
                                            </div>
                                            ...
                                            <div class="review-score-row">
                                                <span>1점</span>
                                                <div class="review-score-track">
                                                    <div class="review-score-fill" data-percent="${rating1Percent}">
                                                    </div>
                                                </div>
                                                <em>
                                                    <fmt:formatNumber value="${rating1Percent}" pattern="0" />%
                                                </em>
                                            </div>
                                    ...
                                    <div class="detail-review-right">
                                        ...
                                        <div class="review-filter-tabs">
                                            <button type="button" class="review-filter-tab active"
                                                data-review-tab="all">
                                                ...
                                                <div id="reviewRatingMenu" class="review-rating-menu">
                                                        ...
                                                        <span class="rating-option-left">
                                                            ...
                                                            <span class="rating-menu-stars">
                                                                <span class="on">★</span><span
                                                                    class="on">★</span><span>★</span><span>★</span><span>★</span>
                                                            </span>
                                                        </span>
                                                    ...
                                                    <button type="button" class="review-rating-option" data-rating-filter="1" data-rating-label="★☆☆☆☆">
                                                        <span class="rating-option-left">
                                                            ...
                                                            <span class="rating-menu-stars">
                                                                <span
                                                                    class="on">★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                                                            </span>
                                                        </span>
                        ...
                        <section class="product-qna-box store-tab-panel" id="qnaBox">
                            ...
                            <c:if test="${not empty qna_list}">
                                <c:forEach var="qna" items="${qna_list}">
                                    ...
                                    <c:set var="isQnaOwner"
                                        value="${not empty sessionScope.user and sessionScope.user.user_id == qna.user_id}" />
