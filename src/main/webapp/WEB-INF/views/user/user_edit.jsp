        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <table class="usertable" id="usertable">
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-row">
                            <input name="login_id" id="login_id" oninput="chk()" value="${dto.user.login_id}" placeholder="아이디를 입력하세요" />
                            <input type="button" value="중복체크" id="login_id_btn" disabled="disabled" class="btn-secondary" onclick="check_loginId()" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="input-row">
                            <input name="nick_name" id="nick_name" oninput="chknick()" value="${dto.user.nick_name}" placeholder="닉네임을 입력하세요" />
                            <input type="button" value="중복체크" id="nick_check_btn" disabled="disabled" class="btn-secondary" onclick="check_nick()" />
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <th>비밀번호 관리</th>
                    <td>
                        <input type="button" value="비밀번호 변경하기" id="toggle-pwd-btn" class="btn-secondary" onclick="togglePassword()" />
                    </td>
                </tr>

                <tr class="pwd-section" style="display: none;">
                    <th>현재 비밀번호</th>
                    <td>
                        <div class="input-row">
                            <div class="input-wrapper" style="flex:1;">
                                <input name="ori_password" id="ori_password" type="password" maxlength="16" oninput="chk2()" placeholder="현재 비밀번호를 입력하세요" />
                ...
                <tr class="pwd-section" style="display: none;">
                    ...
                    <td>
                        <div class="input-wrapper">
                            <input name="password" id="password" type="password" maxlength="16" oninput="checkPwdRules()" placeholder="영문, 숫자 포함 8자 이상 16자 이하" />
                ...
                <tr class="pwd-section" style="display: none;">
                    ...
                    <td>
                        <div class="input-wrapper">
                            <input name="checkPassword" id="checkPassword" type="password" disabled="disabled" maxlength="16" oninput="checkPwdMatch()" placeholder="비밀번호를 다시 입력하세요" />
                ...
                <tr>
                    <th>성별</th>
                    <td>
                        <input type="radio" name="gender" value="male" id="male" <c:if test="${dto.user.gender == 'male'}">checked</c:if> />
                        <label for="male">남자</label>
                        <input type="radio" name="gender" value="female" id="female" <c:if test="${dto.user.gender == 'female'}">checked</c:if> />
                ...
                <tr>
                    ...
                    <td>
                        <c:if test="${dto.user.photo_name ne 'no_file'}">
                            <div id="photo_div">
                                <img src="${pageContext.request.contextPath}/upload/${dto.user.photo_name}" width="80" height="80" />
            ...
            <c:if test="${dto.user.role == 'SELLER' and not empty dto.seller}">
                <table id="sellertable" class="sellertable">
                    ...
                    <tr>
                        <th>사업자 등록번호</th>
                        <td><input name="business_number" value="${dto.seller.business_number}" placeholder="사업자 등록번호" /></td>
                    </tr>
                    <tr>
                        <th>대표자명</th>
            ...
            <div class="btn-area">
                ...
                <c:if test="${dto.user.role == 'USER'}">
                    <input type="button" value="판매자 신청하기" class="btn-seller" onclick="location.href='/update_seller.do'" />
                </c:if>
