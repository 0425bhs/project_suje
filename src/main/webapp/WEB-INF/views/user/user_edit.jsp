            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <table class="usertable" id="usertable">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-row">
                                <input name="login_id" id="login_id" oninput="chk()" value="${dto.user.login_id}"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="input-row">
                                <input name="nick_name" id="nick_name" oninput="chknick()" value="${dto.user.nick_name}"
                    ...
                    <tr>
                        <th>비밀번호 관리</th>
                        <td>
                            <input type="button" value="비밀번호 변경하기" id="toggle-pwd-btn" class="btn-secondary"
                        ...
                        <td>
                            <div class="input-row">
                                <div class="input-wrapper" style="flex:1;">
                                    <input name="ori_password" id="ori_password" type="password" maxlength="16"
                                        oninput="chk2()" placeholder="현재 비밀번호를 입력하세요" />
                        ...
                        <td>
                            <div class="input-wrapper">
                                <input name="password" id="password" type="password" maxlength="16"
                                    oninput="checkPwdRules()" placeholder="영문, 숫자 포함 8자 이상 16자 이하" />
                    ...
                    <tr class="pwd-section" style="display: none;">
                        ...
                        <td>
                            <div class="input-wrapper">
                                <input name="checkPassword" id="checkPassword" type="password" disabled="disabled"
                                    maxlength="16" oninput="checkPwdMatch()" placeholder="비밀번호를 다시 입력하세요" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="gender" value="male" id="male" <c:if
                                test="${dto.user.gender == 'male'}">checked</c:if> />
                            <label for="male">남자</label>
                            <input type="radio" name="gender" value="female" id="female" <c:if
                                test="${dto.user.gender == 'female'}">checked</c:if> />
                ...
                <c:if test="${dto.user.role == 'SELLER'}">
                    <table id="sellertable" class="sellertable">
                        ...
                        <tr>
                            <th>상호</th>
                            <td><input name="company_name" value="${dto.seller.company_name}"
                        ...
                        <tr>
                            <th>대표자명</th>
                            <td><input name="representative_name" value="${dto.seller.representative_name}"
                        ...
                        <tr>
                            <th>사업자 주소</th>
                            <td><input name="business_address" value="${dto.seller.business_address}"
                                    placeholder="사업자 주소를 입력하세요" /></td>
                        </tr>
                    </table>
                </c:if>
                ...
                <div class="btn-area">
                    ...
                    <c:if test="${dto.user.role == 'USER'}">
                        <input type="button" value="판매자 신청하기" class="btn-seller"
