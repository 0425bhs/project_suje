...
public class SellerVO {
   ...
   // private String createdAt;        // created_at : TIMESTAMP (판매자 신청 일시)
    ...
    private String representative_name; // representative_name : VARCHAR(100) (대표자명)
    private String opening_date;        // opening_date : DATE (사업자 개업일자)
    private String business_address;    // business_address : VARCHAR(255) (사업자 주소)
